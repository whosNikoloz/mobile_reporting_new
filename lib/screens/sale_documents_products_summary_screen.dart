...
class SaleDocumentsProductsSummaryScreen extends StatefulWidget {
  const SaleDocumentsProductsSummaryScreen({super.key});

  @override
  State<SaleDocumentsProductsSummaryScreen> createState() => _SaleDocumentsProductsSummaryScreenState();
}

class _SaleDocumentsProductsSummaryScreenState extends State<SaleDocumentsProductsSummaryScreen> {
  ...
  List<SaleDocumentsProductsSummaryResponseModel> _items = [];
  ...
  Future<void> _loadData() async {
    ...
    try {
      final results = await _reportsService.getSaleDocumentsProductsSummary(
  ...
  Widget build(BuildContext context) {
    ...
    String screenTitle = "Sales by Item (Summary)";
    try { screenTitle = l10n.salesByItemSummary; } catch(_) {}
  ...
  Widget _buildRow(SaleDocumentsProductsSummaryResponseModel item, int index) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 14),
      decoration: BoxDecoration(
        border: Border(
