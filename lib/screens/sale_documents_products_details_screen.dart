...
class SaleDocumentsProductsDetailsScreen extends StatefulWidget {
  const SaleDocumentsProductsDetailsScreen({super.key});

  @override
  State<SaleDocumentsProductsDetailsScreen> createState() => _SaleDocumentsProductsDetailsScreenState();
}

class _SaleDocumentsProductsDetailsScreenState extends State<SaleDocumentsProductsDetailsScreen> {
  ...
  List<SaleDocumentsProductsDetailsResponseModel> _items = [];
  ...
  Future<void> _loadData() async {
    ...
    try {
      final results = await _reportsService.getSaleDocumentsProductsDetails(
  ...
  Widget build(BuildContext context) {
    ...
    String screenTitle = "Sales by Item (Detailed)";
    try { screenTitle = l10n.salesByItemDetailed; } catch(_) {}
  ...
  Widget _buildRow(SaleDocumentsProductsDetailsResponseModel item, int index) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
      decoration: BoxDecoration(
        border: Border(
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${DateFormat('dd.MM.yyyy').format(item.tDate)} • ${item.unit}',
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: const TextStyle(
                    fontSize: 12,
