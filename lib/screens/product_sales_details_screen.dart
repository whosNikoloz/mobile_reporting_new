...
class ProductSalesDetailsScreen extends StatefulWidget {
  const ProductSalesDetailsScreen({super.key});

  @override
  State<ProductSalesDetailsScreen> createState() => _ProductSalesDetailsScreenState();
}

class _ProductSalesDetailsScreenState extends State<ProductSalesDetailsScreen> {
  ...
  List<ProductSalesDetailsResponseModel> _items = [];
  ...
  Future<void> _loadData() async {
    ...
    try {
      final results = await _reportsService.getProductSalesDetails(
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            centerTitle: true,
            title: Text(
              l10n.purchasesByItemDetailed, // This points to "purchases by item - detailed"
  ...
  Widget _buildRow(ProductSalesDetailsResponseModel item, int index) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
      decoration: BoxDecoration(
        border: Border(
