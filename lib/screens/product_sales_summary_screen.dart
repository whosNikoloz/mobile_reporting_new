...
class ProductSalesSummaryScreen extends StatefulWidget {
  const ProductSalesSummaryScreen({super.key});

  @override
  State<ProductSalesSummaryScreen> createState() => _ProductSalesSummaryScreenState();
}

class _ProductSalesSummaryScreenState extends State<ProductSalesSummaryScreen> {
  ...
  List<ProductSalesSummaryResponseModel> _items = [];
  ...
  Future<void> _loadData() async {
    ...
    try {
      final results = await _reportsService.getProductSalesSummary(
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            centerTitle: true,
            title: Text(
              l10n.purchasesByItemSummary, // purchases by item despite name product sales
  ...
  Widget _buildRow(ProductSalesSummaryResponseModel item, int index) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 14),
      decoration: BoxDecoration(
        border: Border(
