...
class _CustomerPaymentsScreenState extends State<CustomerPaymentsScreen> {
  ...
  List<VendorPaymentsResponseModel> _items = [];
  ...
  Future<void> _loadData() async {
    ...
    try {
      final results = await _reportsService.getCustomerPayments(
  ...
  Widget _buildRow(VendorPaymentsResponseModel item, int index) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 14),
      decoration: BoxDecoration(
        border: Border(
