...
class BuyersDebtScreen extends StatefulWidget {
  const BuyersDebtScreen({super.key});

  @override
  State<BuyersDebtScreen> createState() => _BuyersDebtScreenState();
}

class _BuyersDebtScreenState extends State<BuyersDebtScreen> {
  final ReportsService _reportsService = ReportsService();
  final ScrollController _scrollController = ScrollController();

  bool _filtersLoaded = false;

  List<BuyersDebtResponseModel> _items = [];
  ...
  /// We use the end of current period as "before" date
  ...
  Future<void> _loadData() async {
    ...
    try {
      final results = await _reportsService.getBuyersDebt(
              ...
              children: [
                PickerWidget(
                  ...
                  getDate: (dt1, dt2, dt3, dt4, min, max, bill) async {
                    // Use the chosen day "to" as before date
                    _beforeDate = dt2;
