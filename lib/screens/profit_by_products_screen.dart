...
class ProfitByProductsScreen extends StatefulWidget {
  const ProfitByProductsScreen({super.key});

  @override
  State<ProfitByProductsScreen> createState() => _ProfitByProductsScreenState();
}

class _ProfitByProductsScreenState extends State<ProfitByProductsScreen> {
  final ReportsService _reportsService = ReportsService();
  final ScrollController _scrollController = ScrollController();

  bool _filtersLoaded = false;

  List<ProfitByProductResponseModel> _items = [];
  ...
  Future<void> _loadData() async {
    ...
    try {
      final results = await _reportsService.getProfitByProducts(
