...
class CategorySalesScreen extends StatefulWidget {
  ...
  @override
  State<CategorySalesScreen> createState() => _CategorySalesScreenState();
}

class _CategorySalesScreenState extends State<CategorySalesScreen> {
  ...
  // Data
  List<CategorySalesResponseModel> _reportData = [];
  ...
  Future<void> _loadData() async {
    ...
    try {
      final response = await _reportsService.getCategorySalesReport(
      ...
      print('❌ Error loading category report: $err');
    }
  ...
  List<PieChartSectionData> _buildPieChartSections() {
    double total = _reportData.fold(0, (sum, item) => sum + item.currentSales);
    if (total == 0) return [];
